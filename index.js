...
const start = async (client = new Client()) => {
        ...
        client.onAddedToGroup(((chat) => {
            ...
            if (totalMem < 5) { 
            	client.sendText(chat.id, `Cih member nya cuma ${totalMem}, Kalo mau invite bot, minimal jumlah mem ada 5`).then(() => client.leaveGroup(chat.id)).then(() => client.deleteChat(chat.id))
            } else {
